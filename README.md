# Chess Tournament Manager - South African Ratings

A web application for managing chess tournaments using the Swiss system with South African rating-based pairing.

## Features

- **Player Management**: Add players with their South African ratings
...
- **Export Functionality**: Export tournament results as JSON
